// Mason Jar Bean Tally - UI Tweaks
// Fix +/- overlap via responsive layout & wider controls.
// Replace player tally with a 3D jar (Jar3D) showing fill level.
//
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="max-w-6xl mx-auto px-2 sm:px-4 py-4">
        <div className="grid lg:grid-cols-[minmax(260px,360px)_1fr] gap-3">
          <section>
          ...
          <section className="flex-1">
            ...
            {/* Prevent +/- overlap: each bean row stacks on small screens; wider buttons & fixed count width */}
            <div className="grid sm:grid-cols-2 xl:grid-cols-2 gap-3">
              {players.map((p) => {
                ...
                return (
                  <div
                    key={p.id}
                    className="group relative bg-white border rounded-2xl p-4 shadow-sm border-slate-200"
                    onClick={(e) => {
